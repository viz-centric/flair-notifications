...
var job = {
    ...
    createJiraTicket: async function (request) {
        ...
        jiraConfig.fields.description.content[4].content[0].marks[0].attrs.href = util.getFlairInsightsLink(reportsData.report.share_link, reportsData.report.reportline.visualizationid, reportsData.report.thresholdAlert);
